...
export default function Search() {
  ...
  return (
    <div onClick={() => searchModal.open()} className='flex border border-gray-300 gap-3 justify-center rounded-full py-[0.4rem] px-4 shadow-sm shadow-gray-200 text-[15px] hover:shadow-md hover:shadow-gray-300 cursor-pointer md:w-auto'>
